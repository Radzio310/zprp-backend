...
Runs every 5 minutes. Currently handles:
  - tournament_reminder_24h: tournament starts in ~24h
  - tournament_reminder_5h:  tournament starts in ~5h
...
async def _generate_tournament_reminders():
    """Generate tournament_reminder_24h and tournament_reminder_5h notifications."""
